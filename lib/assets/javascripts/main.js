...
WJ_Validator.prototype = {
	...
	register_handlers: function(){
		...
		***/
		console.log("CODE CALLED HERE");
		if(event_handlers != ""){
			for(event in event_handlers){
				var comb = event + " custom";
				var comb_ids = event_handlers[event].join(",");
				console.log("registering comb:" + comb + " with comb ids:" + comb_ids);
				$(document).on(comb,comb_ids,function(e,ret){
